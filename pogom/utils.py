...
def get_args():
    ...
    parser.add_argument('-l', '--location', type=parse_unicode, help='Location, can be an address or coordinates', required=True, default='\"76 Woodland Park Drive, Tenafly, NJ\"')
