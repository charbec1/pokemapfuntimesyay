...
def get_args():
    ...
    parser.add_argument('-ar', '--auto-refresh', help='Enables an autorefresh that behaves the same as'
                        ' a page reload. Needs an integer value for the amount of seconds', default=10)
    parser.add_argument('-dp', '--display-pokestops', help='Display pokéstops', action='store_true', default=True)
    parser.add_argument('-dl', '--display-lured', help='Display only lured pokéstop', action='store_true', default=False)
    parser.add_argument('-dg', '--display-gyms', help='Display gyms', action='store_true', default=True)
